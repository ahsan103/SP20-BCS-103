...
function ProductTwo(props) {
  ...
  return (
   <Box sx={{width:250,backgroundColor:'transparent' , padding:2, "&:hover":{cursor:'pointer'}}} >
    <Card sx={{ backgroundColor: !darkTheme?'#F8FAFC':'#CBDFE1' , boxShadow:'none' , height:320 , borderRadius:10 }}component={'div'} onMouseOver={()=>{setMouseEnter(true)}} onMouseOut={()=>{setMouseEnter(false)}}>
        <CardMedia 
         component="img"
